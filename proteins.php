      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>The popularity of vaporization has left little time for conversation on the art of rolling. However, this minimalist, easily accessible, tried-and-true consumption method still reigns supreme globally, and combustion aside, the creative potential and skill required to craft a functional roll is celebrated among many cannabis enthusiasts.</p>
               ...
               <p>If you’re new to hhhhhhh, there are three broad categories by which to delineate rolls (substantiated by withstanding popularity): efbvhjebv buhbruh hbhurbuh. Each can be defined by their content (hhhhhh-tobacco ratio) as well as the paper material (tobacco, hemp, wood pulp, etc.).</p>
        </div>
        <div class="modal-footer">
                <center><button class="w3-button w3-round-xxlarge" style="background-color: lawngreen"><?php echo $row->cost;?></button></center>
                <a href="http://127.0.0.1/CodeIgniter-3.1.9/index.php/splController/add_to_cart_proteins/<?php echo $row->id;?>"><button type="button" class="btn btn-primary" style="float: left; display:<?php echo $btt_state;?>" ><?php echo $btt_text;?></button>
...
function reply_click(id)
{
   //var clicked=clicked_id;
    dc = document.getElementById("my_proteins_model"+id);
    sa= document.getElementByClassName("close")[<?php echo $row->id;?>];
    // sa=s;
    // dc=modal;
    alert("ashu");
