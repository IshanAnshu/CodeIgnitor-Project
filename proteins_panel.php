...
<div class="container">
          ...
          <div class="col-sm-3"><p style="font-size:26px; color: rgb(226, 11, 54)">Proteins Collection</p>
        </div>  
      </div>   
      </div>
  ...
  <div class="col-md-3 col-sm-6" id="proteins_model<?php echo $row->id;?>" onClick="reply_click(<?php echo $row->id;?>)">
      ...
      <img src="<?php  echo base_url(); ?>uploads/<?php echo $row->file_name;?>" class="onPage" alt ="Image" >  
              ...
              <center><a href="http://127.0.0.1/CodeIgniter-3.1.9/index.php/splController/removeProtein/<?php echo $row->id;?>"><button class="w3-button w3-round-xxlarge" style="background-color: rgb(237, 221, 187); color:red;">Remove</button></a></center>
           </div>
      </div>
  </div> 
