...
<div class="modal" id="my_proteins_model<?php echo $row->id;?>">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
                ...
                <a href="http://127.0.0.1/CodeIgniter-3.1.9/index.php/splController/add_to_cart_gainers/<?php echo $row->id;?>"><button type="button" class="btn btn-primary" style="float: left; display:<?php echo $btt_state;?>" ><?php echo $btt_text;?></button>
