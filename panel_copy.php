  ...
  <table class="table">
    <thead>
      <tr>
        ...
        <th><button type="button" class="w3-button w3-round-xxlarge" style="background-color: rgb(175, 213, 237);">Slider 1</button></th>
        <th><button type="button" class="w3-button w3-round-xxlarge" style="background-color: rgb(175, 213, 237);">Slider 2</button></th>
        <th><button type="button" class="w3-button w3-round-xxlarge" style="background-color: rgb(175, 213, 237);">Slider 3</button></th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td>Proteins Image</td>
        <td><button type="button" class="w3-button w3-round-xxlarge" style="background-color: rgb(175, 213, 237);">Change</button></td>       
      </tr>
      <tr>
        <td>Gainers Image</td>
        <td><button type="button" class="w3-button w3-round-xxlarge" style="background-color: rgb(175, 213, 237);">Change</button></td>       
...
<table class="table">
    <thead>
      <tr>
        <th>Show Case</th>
        <th><button type="button" class="w3-button w3-round-xxlarge" style="background-color: rgb(175, 213, 237);">Click to Add</button></th>
     </tr>
    </thead>
    <tbody>
      <tr>
        <td>Proteins</td>
        <td><button type="button" class="w3-button w3-round-xxlarge" style="background-color: rgb(175, 213, 237);">Add Product</button></td>       
      </tr>
      <tr>
        <td>Gainers</td>
        <td><button type="button" class="w3-button w3-round-xxlarge" style="background-color: rgb(175, 213, 237);">Add Product</button></td>       
