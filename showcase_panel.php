...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">  
  ...
  <!-- For the Products section  -->
        ...
        <div id="top_area" class="container">
          <div style="margin-top:6%; margin-left: 4%; background-color:rgb(229, 248, 249);">
             ...
             <p style="font-size:32px; color: rgb(226, 11, 54)">Showcase Collection</p>
  ...
  <div class="col-md-3 col-sm-6" id="proteins_model<?php echo $row->id;?>" onClick="reply_click(<?php echo $row->id;?>)">
      ...
      <img src="<?php  echo base_url(); ?>uploads/<?php echo $row->file_name;?>" class="onPage" alt ="Image" >  
              ...
              <center><a href="http://127.0.0.1/CodeIgniter-3.1.9/index.php/splController/removeShowcaseProduct/<?php echo $row->id;?>"><button class="w3-button w3-round-xxlarge" style="background-color: rgb(237, 221, 187); color:red;">Remove</button></a></center>
           </div>
